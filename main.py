...
#"/Users/md.masum/PycharmProjects/newstreamlineproject/Motor_Vehicle_Collisions_-_Crashes.csv"

DATA_URL = (
    "/Users/md.masum/PycharmProjects/newstreamlineproject/Motor_Vehicle_Collisions_-_Crashes_sheet.csv"
)

st.title("Motor Vehicle Collisions")
st.markdown("#### This is streamlit dashboard that can be used to analyze motor vehicle collisions in NYC.")
